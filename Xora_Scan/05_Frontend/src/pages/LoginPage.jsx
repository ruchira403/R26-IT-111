    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            await Swal.fire({
                ...
                text: 'Your credentials were verified and saved to the database successfully.',
                confirmButtonColor: '#2563eb',
            });
            navigate('/member1/validation');
        } catch (err) {
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 outline-none ${errors.email ? 'border-red-400 bg-red-50 focus:ring-2 focus:ring-red-300' : 'border-slate-200 bg-slate-50 focus:border-brand focus:ring-2 focus:ring-brand/20 hover:border-slate-300'}`}
                            />
                        </div>
                        {errors.email && (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-11 py-3 rounded-xl border text-sm font-medium transition-all duration-200 outline-none ${errors.password ? 'border-red-400 bg-red-50 focus:ring-2 focus:ring-red-300' : 'border-slate-200 bg-slate-50 focus:border-brand focus:ring-2 focus:ring-brand/20 hover:border-slate-300'}`}
                            />
                            <button
                                type="button"
