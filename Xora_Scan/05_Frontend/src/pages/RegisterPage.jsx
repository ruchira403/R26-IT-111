...
export default function RegisterPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const token = payloadData?.accessToken || payloadData?.token || payloadData?.data?.accessToken;
      const user = payloadData?.user || payloadData?.data?.user || null;
      ...
      if (token) {
        ...
        await openSwal({
          ...
          text: 'Your account has been saved to the database successfully.',
        ...
        await openSwal({
          ...
          text: 'The account was not fully created. Please try again.',
