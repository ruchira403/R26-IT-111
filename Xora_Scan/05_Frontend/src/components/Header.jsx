              ...
              <>
                <div className="relative">
                  <button
                    ...
                    className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-brand text-white font-bold text-sm shadow-md shadow-brand/20"
                    aria-label="User menu"
                  >
                    {firstLetter}
                  </button>
                  {avatarMenuOpen && (
                    <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-lg border border-slate-100 z-50">
                      <button
                ...
                <button
                  ...
                  className="px-5 py-2 text-sm font-semibold text-slate-700 hover:text-brand hover:bg-slate-50 rounded-xl border border-transparent hover:border-slate-200 transition-all duration-200 cursor-pointer"
                >
                  Logout
                </button>
              </>
          ...
          <div className="px-4 pt-2 pb-6 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              {isLoggedIn ? (
                <button
                  onClick={handleLogout}
                  className="w-full py-2.5 text-center text-sm font-semibold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors"
                >
                  Logout
                </button>
              ) : (
